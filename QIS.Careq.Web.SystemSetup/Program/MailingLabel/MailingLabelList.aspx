...
CodeBehind="MailingLabelList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.MailingLabelList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnEventInvitationProcess" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Download")%></div></li>
...
//                }
            ...
            $('#btnSearchMember').click(function (evt) {
                if (IsValid(evt, 'fsSearchMember', 'mpEntryPopup')) {
                    ...
                    var LOBClassID = $('#<%=hdnLOBClassID.ClientID %>').val();
                    if (LOBClassID != '' && LOBClassID != '0') {
                        if (filterExpression != "")
                            filterExpression += " AND ";
                        filterExpression += "LOBClassID = " + LOBClassID;
                    }
                            ...
                            <td>
                                ...
                                <table style="width:100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td><asp:TextBox ID="txtLOBClassName" ReadOnly="true" Width="100%" runat="server" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
