<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="UploadEventParticipantList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.UploadEventParticipantList" %>
        ...
        $(function () {
            ...
            $('#<%=btnEventInvitationSet.ClientID %>').click(function () {
                if ($('#<%=hdnID.ClientID %>').val() != '') {
                    document.location = ResolveUrl("~/Program/UploadEventParticipant/UploadEventParticipantDt2.aspx?id=" + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
