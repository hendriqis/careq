    ...
    <script type="text/javascript">
        ...
        function onCustomClickQuickMenuPrint(code) {
            if (code == 'laporanevent') {
                openReportViewer('F000006', "CompanyID = " + $('#<%=hdnID.ClientID %>').val() + " AND GCRegistrationStatus != 'X010^999'");
            }if (code == 'laporanmember') {
                openReportViewer('F000007', "CompanyID = " + $('#<%=hdnID.ClientID %>').val());
            }
        }
    </script>
    <style type="text/css">
