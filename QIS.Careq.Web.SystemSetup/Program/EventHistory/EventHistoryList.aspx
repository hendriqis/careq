<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" CodeBehind="EventHistoryList.aspx.cs" 
    Inherits="QIS.Careq.Web.SystemSetup.Program.EventHistoryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnEventHistoryMember" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Member")%></div></li>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnEventHistoryMember.ClientID %>').click(function () {
                if ($('#<%=hdnID.ClientID %>').val() != '') {
                    document.location = ResolveUrl("~/Program/EventHistory/EventHistoryDtList.aspx?id=" + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
