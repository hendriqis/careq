<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangeLeadStatusCtl.ascx.cs" 
    Inherits="QIS.Careq.Web.SystemSetup.Program.ChangeLeadStatusCtl" %>
...
<div>
    ...
    <div class="pageTitle"><%=GetLabel("Lead Process")%></div>
