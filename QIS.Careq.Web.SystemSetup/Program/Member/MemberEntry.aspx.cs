...
{
    public partial class MemberEntry : BasePageEntry
    {
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtDepartmentCode, new ControlEntrySetting(true, true, false));
            SetControlEntrySetting(txtDepartmentName, new ControlEntrySetting(false, false, false));
            ...
            SetControlEntrySetting(txtLastEventStartDate, new ControlEntrySetting(false, false, false));
            SetControlEntrySetting(txtLastEventEndDate, new ControlEntrySetting(false, false, false));
        ...
        private void EntityToControl(vMember entity)
        {
            ...
            if (entity.LastEventDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != Constant.ConstantDate.DEFAULT_NULL)
                txtLastEventStartDate.Text = entity.LastEventDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
            if (entity.EndDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT) != Constant.ConstantDate.DEFAULT_NULL)
                txtLastEventEndDate.Text = entity.EndDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
