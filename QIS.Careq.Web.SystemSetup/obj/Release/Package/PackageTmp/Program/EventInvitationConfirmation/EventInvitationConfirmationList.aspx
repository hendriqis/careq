<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="EventInvitationConfirmationList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.EventInvitationConfirmationList" %>
        ...
        $(function () {
            ...
            $('#<%=btnEventInvitationSet.ClientID %>').click(function () {
                if ($('#<%=hdnID.ClientID %>').val() != '') {
                    document.location = ResolveUrl("~/Program/EventInvitationConfirmation/EventInvitationConfirmationDt.aspx?id=" + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
