...
namespace QIS.Careq.Web.SystemSetup.Program
{
    public partial class StandardCodeList : BasePageList
    {
        ...
        {
            url = ResolveUrl(String.Format("~/Program/StandardCode/StandardCodeEntry.aspx?par={0}",hdnID.Value));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/StandardCode/StandardCodeEntry.aspx?par={0}&id={1}", hdnID.Value, hdnID1.Value));
                return true;
            }
            return false;
        }
