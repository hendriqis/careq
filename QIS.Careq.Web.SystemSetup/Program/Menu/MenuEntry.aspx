<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="MenuEntry.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.MenuEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#lblParent.lblLink').click(function () {
                ...
                openSearchDialog('menu', filterExpression, function (value) {
            ...
            function onTxtParentCodeChanged(value) {
                var filterExpression = "MenuCode = '" + value + "'";
        ...
        function setCRUDModeEnabled() {
            ...
            if (!isEnabled) {
                ...
                $('#<%=chkView.ClientID %>').prop('checked', false);
                ...
                $('#<%=chkView.ClientID %>').attr("disabled", true);
            }
            else {
                ...
                $('#<%=chkView.ClientID %>').removeAttr("disabled");
            }
        }
    </script>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    <td><asp:CheckBox ID="chkPrint" runat="server" /> <%=GetLabel("Print")%></td>
                                    <td><asp:CheckBox ID="chkApprove" runat="server" /> <%=GetLabel("Approve")%></td>
                                    <td><asp:CheckBox ID="chkView" runat="server" /> <%=GetLabel("View")%></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
