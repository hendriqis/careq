<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserMenuAccessEntryCtl.ascx.cs" 
    Inherits="QIS.Careq.Web.SystemSetup.Program.UserMenuAccessEntryCtl" %>
...
<script type="text/javascript" id="dxss_userrolemenuaccessentryctl">
    ...
    $(function () {
        ...
        $('#<%=ddlUserRole.ClientID %>').change(function () {
            $('#<%=hdnSelectedRole.ClientID %>').val($(this).val());
            $('#<%=hdnCRUDMode.ClientID %>').val(getCRUDMode());
            $('#<%=hdnListMenuID.ClientID %>').val(getListMenuID());
        ...
        $('#<%=hdnPrevSelectedRole.ClientID %>').val($('#<%=ddlUserRole.ClientID %>').val());
    });
    ...
    function onCbpMenuAccessEndCallback(s) {
        $('#<%=hdnPrevSelectedRole.ClientID %>').val($('#<%=hdnSelectedRole.ClientID %>').val());
...
<input type="hidden" runat="server" id="hdnPrevSelectedRole" value="" />
<input type="hidden" runat="server" id="hdnSelectedRole" value="" />
...
<table class="tblEntryContent" style="width:70%">
    ...
    <tr>
        <td class="tdLabel"><label class="lblNormal" runat="server"><%=GetLabel("UserName")%></label></td>
        <td colspan="2"><asp:TextBox ID="txtUserName" ReadOnly="true" Width="100%" runat="server" /></td>
    </tr>    
    <tr>
        <td class="tdLabel"><label id="Label1" class="lblNormal" runat="server" ><%=GetLabel("UserRole")%></label></td>
        <td colspan="2"><asp:DropDownList ID="ddlUserRole" ReadOnly="true" Width="100%" runat="server" /></td>
    </tr>   
    <tr>
