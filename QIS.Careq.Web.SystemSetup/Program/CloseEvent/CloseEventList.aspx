<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="CloseEventList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.CloseEventList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnCloseEventProcess" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbset.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Close")%></div></li> 
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnCloseEventProcess.ClientID %>').click(function () {
                onCustomButtonClick('closeevent');
            });
        });
