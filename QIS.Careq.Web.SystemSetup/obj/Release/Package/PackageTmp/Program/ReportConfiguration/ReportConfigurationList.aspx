<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ReportConfigurationList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.ReportConfigurationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkFilterParameter a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/ReportConfiguration/ReportParameterEntryCtl.ascx");
