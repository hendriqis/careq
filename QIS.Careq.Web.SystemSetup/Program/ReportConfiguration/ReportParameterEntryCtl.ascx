<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportParameterEntryCtl.ascx.cs" 
    Inherits="QIS.Careq.Web.SystemSetup.Program.ReportParameterEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunithealthcareentryctl">
    ...
    $('#lblFilterParameter.lblLink').live('click', function () {
        ...
        openSearchDialog('filterparameter', filterExpression, function (value) {
    ...
    function onTxtFilterParameterCodeChanged(value) {
        var filterExpression = "FilterParameterCode = '" + value + "' AND IsDeleted = 0";
