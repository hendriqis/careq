...
CodeBehind="EmployeeEntry.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.EmployeeEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <div class="pageTitle"><%=GetLabel("CRO")%></div>
        ...
        <tr>
            <td style="padding:5px;vertical-align:top">
                ...
                <table class="tblEntryContent" style="width:100%">
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Employee Code")%></label></td>
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Employee Name")%></label></td>
                        <td>
