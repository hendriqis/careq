function QISClientSearchTextBoxHelper() {
    ...
    this.setParam = function (clientInstance, methodName, filterExpression, valueText, displayText, onLostFocus) {
        ...
        _self.clientInstance.filterExpression = filterExpression;
    }
    ...
    this.getAutoComplete = function () {
        ...
        if (filterExpression != '') {
            if (_self.clientInstance.filterExpression != '')
                filterExpression = _self.clientInstance.filterExpression + ' AND ' + filterExpression;
        }
        else
            filterExpression = _self.clientInstance.filterExpression;
...
function QISClientSearchTextBox() {
    ...
    this.onLoadObject = function (result) {
        if (result == null) {
            ...
            $('#' + _self.clientID + '_divAutoComplete .txtIntellisense').val(result[_self.displayText]);
        }
    }
