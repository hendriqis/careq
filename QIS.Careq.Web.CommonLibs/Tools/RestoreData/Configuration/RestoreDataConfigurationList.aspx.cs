...
namespace QIS.Careq.Web.CommonLibs.Tools
{
    public partial class RestoreDataConfigurationList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.RESTORE_DATA_CONFIGURATION;
        }
        ...
        {
            url = ResolveUrl("~/Libs/Tools/RestoreData/Configuration/RestoreDataConfigurationEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Libs/Tools/RestoreData/Configuration/RestoreDataConfigurationEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
