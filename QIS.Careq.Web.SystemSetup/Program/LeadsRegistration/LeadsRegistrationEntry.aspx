...
CodeBehind="LeadsRegistrationEntry.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.LeadsRegistrationEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        function onLoad() {
            setDatePicker('<%=txtLeadDate.ClientID %>');
        ...
        function leadSourceTypeChanged() {
            var leadSourceType = getOtherLeadSourceType();
            if (cboLeadSourceType.GetValue() == leadSourceType) {
    ...
    <div class="pageTitle"><%=GetLabel("Lead")%></div>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtLeadDate" CssClass="datepicker" Width="120px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Lead Source Type")%></label></td>
                        <td>
                            <dxe:ASPxComboBox ID="cboLeadSourceType" ClientInstanceName="cboLeadSourceType" Width="120px" runat="server" >
                                <ClientSideEvents SelectedIndexChanged="function(s,e){leadSourceTypeChanged();}" />
                            </dxe:ASPxComboBox>
                        </td>
                    </tr>
