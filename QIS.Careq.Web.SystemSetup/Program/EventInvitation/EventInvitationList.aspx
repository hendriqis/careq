<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="EventInvitationList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.EventInvitationList" %>
        ...
        $(function () {
            ...
            $('#<%=btnEventInvitationSet.ClientID %>').click(function () {
                if ($('#<%=hdnID.ClientID %>').val() != '') {
                    document.location = ResolveUrl("~/Program/EventInvitation/EventInvitationDt.aspx?id=" + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
