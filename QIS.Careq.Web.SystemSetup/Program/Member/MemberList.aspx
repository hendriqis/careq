<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="MemberList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.MemberList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkGreetings a').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            openMatrixControl('MemberGreetings', id, 'Member Greetings');
        });

        $('.lnkPastTraining a').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            var url = ResolveUrl("~/Program/Member/MemberPastTrainingCtl.ascx");
            openUserControlPopup(url, id, 'Member Past Training', 800, 500);
        });
    ...
    <style type="text/css">
        ...
        .starnotselected
        {
            width: 16px;
            height: 16px;
            background: url(<%=ResolveUrl("~/Libs/Scripts/jquery/rating/star.gif")%>) no-repeat 0 0px;
        }
        .starselected
        {
            width: 16px;
            height: 16px;
            background: url(<%=ResolveUrl("~/Libs/Scripts/jquery/rating/star.gif")%>) no-repeat 0 -32px;
        }
    </style>
    ...
    <div style="position: relative;">
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MemberNameWithTitle" HeaderText="Member Name" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" />
                                <asp:TemplateField HeaderStyle-Width="330px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("Contact Information")%></HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-Width="300px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("Company")%></HeaderTemplate>
                                    <ItemTemplate>
                                        <%#Eval("CompanyName")%>
                                        <table cellpadding="0" cellspacing="0">
                                            <colgroup>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td class="tdValue"><%#Eval("CompanyAddress")%></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left">
                                    <HeaderTemplate>
                                        <%=GetLabel("Occupation")%></HeaderTemplate>
                                    <ItemTemplate>
                                        <div>
                                            <%#Eval("Occupation") %></div>
                                        <table cellpadding="0" cellspacing="0">
                                ...
                                <asp:TemplateField HeaderStyle-Width="100px" ItemStyle-VerticalAlign="Top">
                                    <HeaderTemplate>
                                        <%=GetLabel("Rating Level")%></HeaderTemplate>
                                    <ItemTemplate>
                                        <ul class="ulRating">
                                            <li>
                                                <div id="divRating1" runat="server" class="starnotselected">
                                                </div>
                                            </li>
                                            <li>
                                                <div id="divRating2" runat="server" class="starnotselected">
                                                </div>
                                            </li>
                                            <li>
                                                <div id="divRating3" runat="server" class="starnotselected">
                                                </div>
                                            </li>
                                            <li>
                                                <div id="divRating4" runat="server" class="starnotselected">
                                                </div>
                                            </li>
                                            <li>
                                                <div id="divRating5" runat="server" class="starnotselected">
                                                </div>
                                            </li>
                                        </ul>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:HyperLinkField HeaderText="Greetings" Text="Greetings" ItemStyle-HorizontalAlign="Center"
                                    ItemStyle-CssClass="lnkGreetings" HeaderStyle-Width="100px" />
                                <asp:HyperLinkField HeaderText="Past Training" Text="Past Training" ItemStyle-HorizontalAlign="Center"
                                    ItemStyle-CssClass="lnkPastTraining" HeaderStyle-Width="100px" />
                            </Columns>
                            <EmptyDataTemplate>
                                No Data To Display
                            </EmptyDataTemplate>
     ...
     <dxpc:ASPxPopupControl ID="pcSearchMember" runat="server" ClientInstanceName="pcSearchMember" EnableHierarchyRecreation="True"
        ...
        PopupVerticalAlign="WindowCenter" CloseAction="CloseButton" Height="500px">
        <ContentCollection>
