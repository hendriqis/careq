<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="EventRegistrationList.aspx.cs" Inherits="QIS.Careq.Web.SystemSetup.Program.EventRegistrationList" %>
        ...
        $(function () {
            ...
            $('#<%=btnEventInvitationSet.ClientID %>').click(function () {
                if ($('#<%=hdnID.ClientID %>').val() != '') {
                    document.location = ResolveUrl("~/Program/EventRegistration/EventRegistrationDtList.aspx?id=" + $('#<%=hdnID.ClientID %>').val());
                }
            });
        });
